                    ...
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            <div class="row">
                                ...
                                <!--搜索开始-->
                                <form method="post" action="/tp02/index.php/Admin/Hot/lists/type/2.html" >
                                    <div class="col-sm-3">
                            ...
                            <!--表格开始    -->
                            <form action="/tp02/index.php/Admin/Hot/lists/type/2.html" method="post" name="updateSort" id="updateSort" >
